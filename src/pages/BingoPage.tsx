...
function BingoRules({ layoutReferenceUrl }: { layoutReferenceUrl: string }) {
  return (
    <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
      ...
      <li>
        <strong className="text-foreground">Засчитывается раунд,</strong> если он
        сыгран полностью по эталонному лейауту, без DNF, в пределах сезона. Без
        шуточных бросков, как в турнире. Не более{' '}
      ...
      <li>
        ...
        ваш лучший зачётный результат за сезон. Отрезки не «закрываются» — каждый
        новый раунд может улучшить или ухудшить итог.
      </li>
      <li>
        ...
        сбрасывает отрезок в 0 очков (нужен новый −1/−2/эйс в следующем раунде).
      </li>
      <li>
        <strong className="text-foreground">Очки за отрезок:</strong> birdie (−1) —{' '}
        <strong>1</strong>, eagle (−2) — <strong>2</strong>, эйс — <strong>4</strong>.
        Итог турнира — сумма очков по всем лункам.
      </li>
    </ul>
  )
}
          ...
          <div className="mt-8 space-y-6">
            <GlassCard>
              <GlassCardContent className="space-y-3 pt-6 text-sm leading-7">
                ...
                {rulesOpen && (
                  <BingoRules layoutReferenceUrl={data.season.layoutReferenceUrl} />
                )}
              </GlassCardContent>
            </GlassCard>
