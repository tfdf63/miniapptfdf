...
const links = [
  { href: 'https://vk.com/tfdf63', label: 'ВКонтакте', icon: VK_ICON },
  { href: 'https://t.me/tfdf63', label: 'Telegram', icon: TG_ICON },
] as const

export function Footer() {
  return (
    <footer className="glass-panel mt-8 flex flex-col items-center gap-4 rounded-2xl border-x-0 border-b-0 py-8">
      <p className="text-muted-foreground text-center text-sm">
        ФФДТ — Федерация флаинг диска Тольятти
      </p>
      <div className="flex justify-center gap-6">
        ...
        <a
          ...
          className="text-muted-foreground transition-all hover:text-primary hover:drop-shadow-[0_0_8px_hsl(var(--primary)/0.6)]"
          aria-label={label}
        >
          {icon}
        </a>
